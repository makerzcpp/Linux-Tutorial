...
- Tomcat 8 安装
    ...
    - 此时（20170609） Tomcat 8 最新版本为：`apache-tomcat-8.5.15.tar.gz`
    ...
    - 移到解压出来文件夹到 /usr 下：`mv apache-tomcat-8.5.15/ /usr/program/`
    - 为了方便，修改解压目录的名字：`mv /usr/program/apache-tomcat-8.5.15/ /usr/program/tomcat8/`
